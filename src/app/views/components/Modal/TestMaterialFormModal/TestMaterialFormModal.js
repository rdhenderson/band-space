...
import TestMaterialForm from './TestMaterialForm'
...
class TestMaterialFormModal extends Component {
...
export default connect(mapStateToProps, mapDispatchToProps)(TestMaterialFormModal);
