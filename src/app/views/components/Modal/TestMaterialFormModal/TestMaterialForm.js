...
class TestMaterialForm extends Component {
  ...
  render() {
    const {onSubmit, handleSubmit, pristine, numPizzas, reset, submitting} = this.props;
    return (
      <form onSubmit={handleSubmit, onSubmit}>
        ...
        <div>
          <Field name="event" component={RadioButtonGroup}>
...
TestMaterialForm = connect(state => ({
  numPizzas: selector(state, 'venues'),
}))(TestMaterialForm);

TestMaterialForm = reduxForm({
  form: 'example',
  initialValues: {
    delivery: 'delivery',
    name: 'Jane Doe',
