  ...
  return (
    <form className="reviewModal" onSubmit={handleSubmit(onSubmit)}>
      ...
      <div>
        ...
        <div className="reviewModal__radio">
          <label><Field name="survey.musicality" component="input" type="radio" value="1"/> 1</label>
          <label><Field name="survey.musicality" component="input" type="radio" value="2"/> 2</label>
          <label><Field name="survey.musicality" component="input" type="radio" value="3"/> 3</label>
          <label><Field name="survey.musicality" component="input" type="radio" value="4"/> 4</label>
          <label><Field name="survey.musicality" component="input" type="radio" value="5"/> 5</label>
        </div>
      </div>
      <div>
        <label>Showmanship</label>
        <div className="reviewModal__radio">
          <label><Field name="survey.showmanship" component="input" type="radio" value="1"/> 1</label>
          <label><Field name="survey.showmanship" component="input" type="radio" value="2"/> 2</label>
          <label><Field name="survey.showmanship" component="input" type="radio" value="3"/> 3</label>
          <label><Field name="survey.showmanship" component="input" type="radio" value="4"/> 4</label>
          <label><Field name="survey.showmanship" component="input" type="radio" value="5"/> 5</label>
        </div>
      </div>
      <div>
        <label>Sound</label>
      ...
      <div>
        <label>On an overall scale of meh (1) to Amazing!(5) how would you rate this group?</label>
        <div className="reviewModal__radio">
...
export default reduxForm({
  form: 'groupReviewForm'  // a unique identifier for this form
})(GroupReviewForm)
